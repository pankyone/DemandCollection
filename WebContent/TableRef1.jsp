...
String addsql="";
if(searchword==""||searchword=="null"||searchword==null)
{
	addsql=" where xqstatus1 != 2 and xqstatus1!=0";
}
else
{
	if(search1.equals("pass"))
	{
		if(search2.equals("pass"))
		{
			addsql = " where " + searchword + " like '%" + text + "%' and xqstatus2 = 1";
		}
		else if(search2.equals("reject"))
		{
			addsql = " where " + searchword + " like '%" + text + "%' and xqstatus2 = -1";
		}
		else
		{
			addsql = " where " + searchword + " like '%" + text + "%' and xqstatus1 = 1";
		}
	}
	else
	{
