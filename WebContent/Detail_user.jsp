...
#instruction{height:16px;border:1px #999 solid;}
...
if(rs.next())
{
	...
	++i;
	xqreason1=rs.getString(++i);
	++i;
	xqreason2=rs.getString(++i);
}
String xqreason = "";
if(xqstatus.equals("-1"))
{
	xqreason = xqreason1;
}
else if(xqstatus.equals("-2"))
{
	xqreason = xqreason2;
}
else
...
function myfun()
{
	var xqstatus = '<%=xqstatus%>';

	if(xqstatus=="-1"||xqstatus=="-2")
	{
		$("#reason-div").show();
	}
	else
...
<div id="reason-div" style="margin:40px 0px; margin-left:250px;display:none;">
	<label>原因</label><br>
	<textarea id = "reason" style="width:666px;height:100px;margin-top:10px;"><%=xqreason %></textarea>
</div>
